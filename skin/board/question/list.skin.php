...
<div class="contents">
    <div id="ctn_wrap">
        ...
        <div class="ctn_txt online">
            <div class="menu_tab">
                <ul>
                    <li onclick="location.href='<?php echo G5_BBS_URL?>/board.php?bo_table=consulting'"><strong>할부</strong>상담</li>
                    <li class="active" onclick="location.href='<?php echo G5_BBS_URL?>/board.php?bo_table=question'"><strong>궁금</strong>합니다</li>
                </ul>
            </div>
        </div>
