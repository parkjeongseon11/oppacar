...
<div class="contents">
    <div id="ctn_wrap">
        <div class="ctn_tit online">
            <h2><span>온라인</span>상담</h2>
            <p>ONLINE COUNSELING SERVICE</p>
        </div>
        <div class="ctn_txt online">
            <div class="menu_tab">
                <ul>
                    <li class="active" onclick="location.href='<?php echo G5_BBS_URL?>/board.php?bo_table=consulting'"><strong>할부</strong>상담</li>
                    <li onclick="location.href='<?php echo G5_BBS_URL?>/board.php?bo_table=question'"><strong>궁금</strong>합니다</li>
                </ul>
            </div>
        </div>
...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <th scope="col">제목</th>
            <th scope="col">작성자</th>
            <th scope="col"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>작성일자 </a></th>
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_num"><?php echo date("Y-m-d", strtotime($list[$i]['wr_datetime'])) ?></td>
    ...
    <fieldset id="bo_sch">
        ...
        <button type="submit" value="검색" class="sch_btn"><span class="text_sh">검색</span></button>
        </form>
    </fieldset>
    <!-- } 게시판 검색 끝 -->   
</div>
